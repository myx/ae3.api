 ...
 */
@ReflectionDisable
public class BaseNativeObject extends BaseNative<Bindings> implements Bindings
/**
 ...
 */
{
	 ...
	 */
	@Deprecated
	public static final void fromBase(final BaseNativeObject object) {
		//
	}
	 ...
	 * @return
	 */
	public static final BaseNativeObject fromBase(final BaseObject<?> object) {
		return object instanceof BaseNativeObject
				? (BaseNativeObject) object
				: new BaseNativeObject( object );
	}
	 ...
	 * @return
	 */
	public static final BaseNativeObject fromMap(final Map<String, Object> map) {
		if (map instanceof BaseNativeObject) {
			return (BaseNativeObject) map;
		}
		final BaseNativeObject base = new BaseNativeObject();
		if (map != null) {
			base.putAll( map );
		}
		return base;
	 ...
	 * @param dynamic
	 */
	public BaseNativeObject(final String key,
	...
	public boolean baseDefine(
			...
			final boolean enumerable,
			final boolean dynamic) {
		assert namePrimitive != null : "Name is NULL";
	...
	public final BaseObject<?> baseGet(final BasePrimitiveString name, final BaseObject<?> defaultValue) {
		if (this.properties != null) {
			for (final BaseProperty property = this.properties.find( name.toString() ); property != null;) {
	...
	public boolean equals(final Object o) {
		 ...
		 */
		if (o instanceof BaseNative<?> && this.prototype == object.basePrototype()) {
