...
final class PropertiesStringDirectToTree implements BasePropertiesString {
	...
	private static final short		TRESHOLD			= 10;
	...
	PropertiesStringDirectToTree(final BasePropertyDataString property1,
			final String name2,
	...
	public BasePropertiesString add(final String name, final BasePropertyDataString property) {
		...
		if (replaced == null) {
			if (++this.size >= PropertiesStringDirectToTree.TRESHOLD) {
