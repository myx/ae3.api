 ...
 * 
 */
final class BasePropertyHolderString extends BasePropertyDataString {
	 ...
	 * @param dynamic
	 */
	public BasePropertyHolderString(final BaseObject<?> value,
	 ...
	 * @param attributes
	 */
	public BasePropertyHolderString(final BaseObject<?> value, final int attributes) {
		super( attributes );
		this.value = value;
	}
	 ...
	 * @param dynamic
	 */
	public BasePropertyHolderString(final String name,
	...
	public BaseObject<?> propertyGet(final BaseObject<?> instance, final BasePrimitive<?> name) {
		...
		assert name.toString() == this.name || name.equals( this.name ) : "Names must match for this type of property: (this.name="
				+ this.name
				+ ", name="
				+ name
				+ ")";
