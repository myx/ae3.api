...
final class PropertiesStringTreeMap extends TreeMap<String, BasePropertyDataString> implements BasePropertiesString {
	...
	PropertiesStringTreeMap() {
		//
	}
	
	PropertiesStringTreeMap(final BasePropertyDataString property1,
			final String name2,
