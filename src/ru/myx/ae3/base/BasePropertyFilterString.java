 ...
 * 
 */
final class BasePropertyFilterString extends BasePropertyDataString {
	 ...
	 * @param dynamic
	 */
	public BasePropertyFilterString(final BaseProperty property,
		...
		if (property instanceof BasePropertyFilterString) {
			final BasePropertyFilterString filter = (BasePropertyFilterString) property;
	 ...
	 * @param dynamic
	 */
	public BasePropertyFilterString(final String name,
	...
	public BaseObject<?> propertyGet(final BaseObject<?> instance, final BasePrimitive<?> name) {
		...
		assert name.toString().equals( this.name.toString() ) : "Names must match for this type of property: (this.name="
				+ this.name
				+ ", name="
				+ name
				+ ")";
